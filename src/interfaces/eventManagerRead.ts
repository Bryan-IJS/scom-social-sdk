import { IFetchPaymentActivitiesOptions, IIdentityClaimResult, IPaymentActivity, ITokenActivity } from "./misc";
...
export namespace SocialEventManagerReadOptions {
	...
	export interface IFetchUserCommunityScoreLogs extends ICommunityBasicInfo {
		pubKey: string;
	}
	export interface IFetchStakeRequestEvent {
		pubkey: string;
		since?: number;
		until?: number;
	}
